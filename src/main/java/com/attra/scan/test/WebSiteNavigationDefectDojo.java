...
// 	    actions1.moveToElement(SelectCreatedPrd).build().perform();
 	    driver.findElement(By.cssSelector("#side-menu > li:nth-child(2) > ul:nth-child(2) > li:nth-child(2) > a:nth-child(1)")).click();
 	    Thread.sleep(3000);
	    }
...
// 	    	Thread.sleep(5000);
 	       ...
 	       log.info("wait for import screen 0");
 	        Thread.sleep(3000);
 	    }
	    ...
	    public void ImportScan() throws Exception  {
		 	WebDriverWait wait=new WebDriverWait(driver, 20);
		 	WebElement ActivateFinding = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[3]/div/form/div[3]/div/div/i")));
		 	Actions actions1 = new Actions(driver);
		 	actions1.moveToElement(ActivateFinding).click().build().perform();
			...
			driver.findElement(By.id("id_file")).sendKeys("/root/Music/report.xml");
//			WebDriverWait wait2=new WebDriverWait(driver, 20);
